    ...
    <div className="min-h-screen w-full flex bg-white">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 lg:p-24 bg-white relative">
        <div className="w-full max-w-md">
          {/* Header */}
          <Link to="/" className="text-3xl font-black text-slate-900 tracking-tight flex items-center gap-2 mb-12">
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-between pt-2">
              ...
              <Link to="/forgot-password" title="Forgot Password" className="text-sm font-bold text-blue-600 hover:text-blue-700 transition-colors">Forgot password?</Link>
            </div>

            <button
              type="submit"
              disabled={loading}
              className="w-full bg-slate-900 text-white py-4 rounded-xl font-bold text-lg hover:bg-slate-800 transition-all hover:shadow-lg hover:shadow-slate-900/20 flex items-center justify-center gap-2 mt-4 disabled:opacity-70 disabled:cursor-not-allowed group"
            >
          ...
          <p className="mt-10 text-center text-slate-600 font-medium">
            ...
            <Link to="/register" className="font-bold text-blue-600 hover:text-blue-700 hover:underline underline-offset-4 transition-all">Sign up now</Link>
          </p>
        </div>
      </div>
        ...
        <div className="relative z-10 p-16 flex flex-col justify-end h-full w-full">
          <div>
            <h1 className="text-5xl lg:text-6xl font-bold text-white mb-6 leading-[1.1] tracking-tight">
              Welcome back to<br />the cutting edge.
            </h1>
            <p className="text-slate-300 text-lg mb-8 max-w-md leading-relaxed">
              Sign in to access your wishlist, track orders, and discover new personalized recommendations just for you.
            </p>
          </div>
